...
console.log("BASE64 LENGTH:", process.env.GOOGLE_CREDENTIALS_BASE64?.length);
console.log("BASE64 START:", process.env.GOOGLE_CREDENTIALS_BASE64?.slice(0, 30));
console.log("BASE64 END:", process.env.GOOGLE_CREDENTIALS_BASE64?.slice(-30));
